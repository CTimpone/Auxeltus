...
namespace Auxeltus.AccessLayer.Sql.Migrations
{
    ...
    [Migration("20220526224601_FixJobRemoteCheckConstraint")]
    partial class FixJobRemoteCheckConstraint
    {
            ...
            modelBuilder.Entity("Auxeltus.AccessLayer.Sql.Job", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_EmployeeLocationSanity", "([LocationId] IS NOT NULL AND [Remote] = 0) OR ([Remote] = 1 AND [LocationId] IS NULL)");
                });
